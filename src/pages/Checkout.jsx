...
const Checkout = () => {
  return (
    <div className="bg-white" onLoad={() => handleRemoveCartItem()}>
        ...
        <div className="mx-auto text-center isolate overflow-hidden bg-gray-900 shadow-2xl rounded-3xl flex gap-x-20 px-24 py-16">
          ...
          <div className="mx-auto max-w-md lg:py-32">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Recibirá un correo de confirmación con el detalle de su compra y el código de seguimiento de su pedido.
            </p>
